...
# def draw_nuclear_plant(start_one, start_two, end_one):
#     p = [0, 0, 0]
#     # base
...
# draw_nuclear_plant(XRES/4, 0, (2 * YRES) / 5)
# draw_nuclear_plant(XRES/2, 0, (2 * YRES) / 5)
# draw_nuclear_plant(3 * XRES / 4, 0, (2 * YRES) / 5)
